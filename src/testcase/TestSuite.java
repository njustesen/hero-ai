...
public class TestSuite {
	...
	private static void RollingMutRate(int runs, String size) {
		...
		AI p2 = new RollingHorizonEvolution(100, .66, .5, 8000, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.5), new HeuristicEvaluator(false)));
		AI p1 = new RollingHorizonEvolution(100, .33, .5, 8000, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.5), new HeuristicEvaluator(false)));
		AI p3 = new RollingHorizonEvolution(100, .5, .5, 8000, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.5), new HeuristicEvaluator(false)));
	...
	private static void RollingKillRate(int runs, String size) {
		...
		AI p2 = new RollingHorizonEvolution(100, .5, .66, 8000, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.5), new HeuristicEvaluator(false)));
		AI p1 = new RollingHorizonEvolution(100, .5, .33, 8000, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.5), new HeuristicEvaluator(false)));
		AI p3 = new RollingHorizonEvolution(100, .5, .5, 8000, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.5), new HeuristicEvaluator(false)));
	...
	private static void RollingVsGreedyAction(int runs, String size) {
		...
		AI p1 = new RollingHorizonEvolution(100, .5, .5, 8000, new RolloutEvaluator(1, 1, new RandomHeuristicAI(0.5), new HeuristicEvaluator(false)));
